...
func NewCreateTransactionUseCaseUow(
	...
	accountGateway gateway.AccountGateway,
	eventDispatcher events.EventDispatcherInterface,
	transactionCreatedEvent events.EventInterface) *CreateTransactionUseCaseUow {
...
func (uc *CreateTransactionUseCaseUow) Execute(input *CreateTransactionInputDTO) (*CreateTransactionOutputDTO, error) {
